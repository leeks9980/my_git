...
if __name__ == "__main__": 
    #Parameter set
    POPULATION_SIZE = 50
    CROSSOVER_PROBABILITIES = .7
    MUTATION_PROBABILITY = [0, .3, 1]   #돌연변이 확률에 따라 달라지는 결과를 확인하기 위함
    MAX_GENERATIONS = 10
    ...
    for MUTATION_PROBABILITY in MUTATION_PROBABILITY:
        ...
        while generation_number < MAX_GENERATIONS:
            ...
            crossed_offspring = crossover_operation(offspring, crossover, CROSSOVER_PROBABILITIES)
            ...
            plt.yticks([])
            plt.title(
                f"Crossover Probability: {CROSSOVER_PROBABILITIES}, Generation: {generation_number} \n"
        ...
        print(f'Best Individual: {best_individual} for crossover probability: {MUTATION_PROBABILITY}')
